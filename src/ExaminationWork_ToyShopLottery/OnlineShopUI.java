 ...
 * с соответствующим сообщением. Эта строка также записывается в файл prizes.txt с указанием даты и времени события.
 * Таким образом prizes.txt представляет собой нечто вроде лог-файла.
